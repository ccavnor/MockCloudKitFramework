...
<img src="Resources/successful_test.gif" alt="testing with success conditions" width="250"/>

However, we can easily tell MCF that we want the transaction to fail with a certain error:

<img src="Resources/failure_test.gif" alt="testing with failure conditions" width="250"/>
